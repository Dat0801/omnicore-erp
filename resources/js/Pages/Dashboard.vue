...
const getStatusColor = (status) => {
    switch (status) {
        ...
        case 'Picking': return 'bg-indigo-100 text-indigo-800';
...
<template>
    ...
    <AdminLayout>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div v-for="(stat, index) in props.stats" :key="index" class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                <tr v-for="order in props.activeOrders" :key="order.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    ...
                    <div class="space-y-6">
                        <div v-for="(item, index) in props.lowStockItems" :key="index" class="flex items-center justify-between pb-6 border-b border-gray-100 dark:border-gray-700 last:border-0 last:pb-0">
                            <div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    ...
                    <div class="space-y-6">
                        <div v-for="(wh, index) in props.warehouseStatus" :key="index">
